...
1. [PageSex.kt](app/src/kotlin/ir/mahdiparastesh/sexbook/PageSex.kt) :
   ...
   It uses the [Report.java](app/src/kotlin/ir/mahdiparastesh/sexbook/data/Report.java) database model.
...
2. [PageLove.kt](app/src/kotlin/ir/mahdiparastesh/sexbook/PageLove.kt) :
   ...
   It uses the [Crush.java](app/src/kotlin/ir/mahdiparastesh/sexbook/data/Crush.java) database model.
...
- [**Estimation.kt**](app/src/kotlin/ir/mahdiparastesh/sexbook/Estimation.kt) :
  ...
  It uses the [Guess.java](app/src/kotlin/ir/mahdiparastesh/sexbook/data/Guess.java) database model.
- [**Places.kt**](app/src/kotlin/ir/mahdiparastesh/sexbook/Places.kt) :
  ...
  It uses the [Place.java](app/src/kotlin/ir/mahdiparastesh/sexbook/data/Place.java) database model.
