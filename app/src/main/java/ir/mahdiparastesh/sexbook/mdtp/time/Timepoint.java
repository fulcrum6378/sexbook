...
import static ir.mahdiparastesh.sexbook.mdtp.time.Timepoint.TYPE.HOUR;
import static ir.mahdiparastesh.sexbook.mdtp.time.Timepoint.TYPE.MINUTE;
...
public class Timepoint implements Parcelable, Comparable<Timepoint> {
    ...
    public boolean equals(@Nullable Timepoint time, @NonNull TYPE resolution) {
        ...
        switch (resolution) {
            case SECOND:
                output = time.getSecond() == getSecond();
            case MINUTE:
